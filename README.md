...
└── pages/
    ...
    ├── Analytics.tsx      ← Sharpe/Sortino, drawdown, calendar returns
...
**Monitoring:** Funding accrues hourly, tracked from Hyperliquid's `cumFunding.sinceOpen`.

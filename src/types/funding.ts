...
export interface FundingRate {
  ...
  persistenceHours: number; // consecutive hours above entryThreshold (for display/analytics)
  sparkline7d: number[];    // last 168 hourly rates (oldest first) for mini-chart
}

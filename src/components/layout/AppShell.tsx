...
import { LayoutGrid, Activity, BarChart2, Briefcase, Settings, Menu, X, Bot } from 'lucide-react';
...
import AutoTraderService from '../shared/AutoTraderService';
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minWidth: 0 }}>
        <ModeBanner />
        <TopBar onPositionsClick={isMobile ? () => setMobilePositionsOpen(true) : undefined} positionCount={positionCount} />
        <main style={{

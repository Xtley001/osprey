...
import { Search, RefreshCw, Layers, Wifi, WifiOff } from 'lucide-react';
...
// Shows whether live HL data is connected, stale, or errored
const ConnectionStatus: React.FC = () => {
  ...
  const isStale  = ageMs > 120_000; // stale after 2 min
  ...
  return (
    <header style={{
      ...
      <div style={{ marginLeft: isMobile ? 0 : 'auto', display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        {onPositionsClick && (
          <button onClick={onPositionsClick} style={{

...
/**
 * Estimate hourly funding income on the perp leg of a position.
 * Used for pre-entry display (EntryModal) and rebalance cost estimation.
 * Live positions use HL's cumFunding.sinceOpen from the clearinghouseState API.
 */
export function estimateHourlyFunding(params: {
  perpNotional:  number;
